...
public class TakeScreenshot2 {
	...
	public static void main(String[] args) throws IOException {
		...
		FileUtils.copyFile(sourcefile1,new File("D:\\SeliniumWorkspace\\InterviewTestNGFramework\\Screenshots\\Screenshot.png"));
		driver.findElement(By.id("link2")).click();
		//Take a ScreenShot
		File sourcefile2=((TakesScreenshot)driver).getScreenshotAs(OutputType.FILE);
		FileUtils.copyFile(sourcefile2,new File("D:\\SeliniumWorkspace\\InterviewTestNGFramework\\Screenshots\\Screenshot2.png"));
		driver.quit();

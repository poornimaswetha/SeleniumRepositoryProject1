...
public class Listeners extends CaptureScreenShot implements ITestListener {
	...
	public void onTestSuccess(ITestResult result) {
		extenttest.log(Status.PASS, "Test Execution is Passed for Test Case : "+ result.getName());
		System.out.println("Test Execution is Passed for Test Case : " +result.getName());
	}
	...
	public void onFinish(ITestContext context) {
		extenttest.log(Status.INFO, "Test Execution of Project got Finished : " + context.getName());

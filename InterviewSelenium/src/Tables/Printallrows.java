...
public class Printallrows {
	...
	public static void main(String[] args) {
		...
		List<WebElement> hd=driver.findElements(By.xpath("//table[@id='table1']//tr"));
		System.out.println(hd.size());// Total 5 rows inside table, Each row will be taken as one list.

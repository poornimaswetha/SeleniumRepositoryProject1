...
public class IsenalbedAPI{
	...
	public static void main(String[] args) throws InterruptedException {
		...
		boolean bol1=driver.findElement(By.id("but2")).isEnabled();
		
		//id=but1 is a visible but disabled button 
		boolean bol2=driver.findElement(By.id("but1")).isEnabled();

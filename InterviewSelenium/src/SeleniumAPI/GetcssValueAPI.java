...
public class GetcssValueAPI{
	...
	public static void main(String[] args) throws InterruptedException {
		...
		//wait for 3 secs
		Thread.sleep(3000);
		//To get the Cascade style sheet value of its css attribute
		String cssval=driver.findElement(By.id("home")).getCssValue("color");
		System.out.println(cssval);	
		// convert Hex colour #ccc to rgba colour and then compare actual and expected result
		boolean s=cssval.equals("rgba(204, 204, 204, 1)");
